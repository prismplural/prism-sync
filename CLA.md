...
Thank you for your interest in contributing to Prism. To clarify the intellectual
property license granted with contributions from any person or entity, Prism must
have a signed Contributor License Agreement ("CLA") from each contributor,
...
by the copyright owner that is making this Agreement. For legal entities, the entity
making a Contribution and all other entities that control, are controlled by, or are
under common control with that entity are considered to be a single Contributor.

**"Contribution"** shall mean any original work of authorship, including any
modifications or additions to an existing work, that is intentionally submitted by
You for inclusion in, or documentation of, any of the products owned or managed by
Prism (the "Work"). For the purposes of this definition, "submitted" means any form
of electronic, verbal, or written communication sent to the project maintainers,
...
the project for the purpose of discussing and improving the Work, but excluding
communication that is conspicuously marked or otherwise designated in writing by You
as "Not a Contribution."

## 1. Grant of Copyright License

Subject to the terms and conditions of this Agreement, You hereby grant to
Skylar Taylor-Barrick and to recipients of software distributed by the project a
...
The project maintainer shall be entitled to make Your Contribution available under
a proprietary license (for example, to distribute through app stores under terms
incompatible with the AGPL), **provided that the project maintainer shall also make
Your Contribution available under the terms of an OSI-approved open source license.**
...
- If your employer(s) has rights to intellectual property that you create that
  ...
  Corporate CLA.
- Each of Your Contributions is Your original creation. You represent that Your
...
all. Unless required by applicable law or agreed to in writing, You provide Your
...
separately from any Contribution, identifying the complete details of its source and
of any license or other restriction (including, but not limited to, related patents,
...
By submitting a pull request to any Prism repository, you indicate that you have read,
understood, and agree to this Contributor License Agreement. Your Git commit sign-off
(`Signed-off-by: Name <email>`) serves as your electronic signature.
